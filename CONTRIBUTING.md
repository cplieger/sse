...
- `ssetest/`: the test seam consumers reuse (`Serve`, `ReadFrames`, `FrameReader`, `Recorder`) and the `Fixture` the TypeScript suites drive; `ssetest/cmd` is the fixture binary.
